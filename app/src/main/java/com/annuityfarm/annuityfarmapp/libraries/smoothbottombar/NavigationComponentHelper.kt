...
import com.annuityfarm.annuityfarmapp.gone
import com.annuityfarm.annuityfarmapp.show
...
class NavigationComponentHelper {
    ...
    companion object {
        ...
        fun setupWithNavController(
            ...
            view: TextView,
            image: AppCompatImageButton
        ) {
            smoothBottomBar.onItemSelectedListener = object : OnItemSelectedListener {
                override fun onItemSelect(pos: Int): Boolean {
                    view.apply { text  = when(pos){
                        1 ->  resources.getString(R.string.pension)
                        2 -> resources.getString(R.string.annuity)
                        3 -> resources.getString(R.string.income_draw_down)
                        4 -> resources.getString(R.string.money_investment)
                        else -> resources.getString(R.string.annuity_firm)
                    } }
