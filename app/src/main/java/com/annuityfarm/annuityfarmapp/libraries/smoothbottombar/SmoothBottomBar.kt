...
import com.annuityfarm.annuityfarmapp.libraries.smoothbottombar.ext.d2p
...
class SmoothBottomBar @JvmOverloads constructor(
    ...
    override fun onSizeChanged(w: Int, h: Int, oldw: Int, oldh: Int) {
        ...
        itemWidth = (width - (barSideMargins * 2)) / items.size + 20
    ...
    fun setupWithNavController(menu: Menu, navController: NavController, view: TextView, image: AppCompatImageButton) {
        NavigationComponentHelper.setupWithNavController(menu, this, navController, view,image)
    }
